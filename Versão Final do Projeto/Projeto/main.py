...
youtube_video_url = "https://youtu.be/hDqqdBw6Oc8"  # Substitua pela URL do seu vídeo
...
def reiniciar_jogo():
    global vida_personagem, pontuacao, round_atual, max_inimigos_round, fim_de_jogo
    vida_personagem = 150
    pontuacao = 0
    round_atual = 0
